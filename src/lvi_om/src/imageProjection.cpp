...
public:
    ImageProjection() : deskewFlag(0)
    {
        ...
        pubExtractedCloud = nh.advertise<sensor_msgs::PointCloud2>("lvi_om/deskew/cloud_deskewed", 1);
        pubLaserCloudInfo = nh.advertise<lvi_om::cloud_info>("lvi_om/deskew/cloud_info", 1);
